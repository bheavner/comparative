% a script to run my model tests and save the results for further analysis
%
% by Ben Heavner 12 September 2013

%% first, load the models for comparison
load('models/iFF.mat'); % doi:10.1101/gr.234503
load('models/iND.mat'); % doi:10.1101/gr.2250904
load('models/iIN800.mat'); % from Markus Herrgard on 6/24/2013, doi:10.1186/1752-0509-2-71
load('models/iMM.mat'); % doi:10.1186/1752-0509-3-37
load('models/Y4.mat'); % 4.05 from yeast.sf.net doi:10.1186/1752-0509-4-145
load('models/iAZ.mat'); % doi:10.1186/1752-0509-4-178
load('models/bs.mat'); % doi:10.1038/ng.846
load('models/Y5.mat'); % 5.01 from yeast.sf.net doi:10.1186/1752-0509-6-55
load('models/iTO_bh.mat'); % from Markus Herrgard on 6/24/2013, modified by bh to add gene info f: 0.8333 doi:10.1186/1752-0509-7-36
load('models/Y6.mat'); % 6.06 from yeast.sf.net doi:10.1093/database/bat059

%% look for genes unique to each model
% don't include bs since it is the same as iMM
iFF_unique = setdiff(iFF.genes, ...
    unique([iND.genes; iIN.genes; iMM.genes; iAZ.genes; Y4.genes; ...
    Y5.genes; Y6.genes; iTO.genes])); % 4

iND_unique = setdiff(iND.genes, ...
    unique([iFF.genes; iIN.genes; iMM.genes; iAZ.genes; Y4.genes; ...
    Y5.genes; Y6.genes; iTO.genes])); % 0

iIN_unique = setdiff(iIN.genes, ...
    unique([iND.genes; iFF.genes; iMM.genes; iAZ.genes; Y4.genes; ...
    Y5.genes; Y6.genes; iTO.genes])); % 0

iMM_unique = setdiff(iMM.genes, ...
    unique([iND.genes; iIN.genes; iFF.genes; iAZ.genes; Y4.genes; ...
    Y5.genes; Y6.genes; iTO.genes])); % 0

Y4_unique = setdiff(Y4.genes, ...
    unique([iND.genes; iIN.genes; iMM.genes; iAZ.genes; iFF.genes; ...
    Y5.genes; Y6.genes; iTO.genes])); % 19

iAZ_unique = setdiff(iAZ.genes, ...
    unique([iND.genes; iIN.genes; iMM.genes; iFF.genes; Y4.genes; ...
    Y5.genes; Y6.genes; iTO.genes])); % 2

Y5_unique = setdiff(Y5.genes, ...
    unique([iND.genes; iIN.genes; iMM.genes; iAZ.genes; Y4.genes; ...
    iFF.genes; Y6.genes; iTO.genes])); % 0

iTO_unique = setdiff(iTO.genes, ...
    unique([iND.genes; iIN.genes; iMM.genes; iAZ.genes; Y4.genes; ...
    Y5.genes; Y6.genes; iFF.genes])); % 35

Y6_unique = setdiff(Y6.genes, ...
    unique([iND.genes; iIN.genes; iMM.genes; iAZ.genes; Y4.genes; ...
    Y5.genes; iFF.genes; iTO.genes])); % 5

%% find non-verified ORFs unique to each model
% list of 5061 verified ORFs taken from SGD (27 August 2013)
