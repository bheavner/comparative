function [results]=testYeastModel_complex(model,varargin)

    % a formalised test-suite for validating yeast models. reliant on the
    % cobra toolbox. This function tests using the complex medium defined
    % by Kennedy et al (doi 10.1534/genetics.109.105254)
    %
    % Input:
    ...
    %              Yeast 7 - http://yeast.sf.net (to be published)
    %
    %   biomass (optional)
    ...
    %             auxotrophs generated from the Saccharomyces Genome
    %             Database (http://www.yeastgenome.org/),
    %             doi:10.1101/gr.3992505, and other sources as indicated.
    %
    ...
    [biomass blocked output] = optargs{:};
    ...
    %% create model with complex medium 
    %(all exchange reactions allowed to carry flux)
    %
    % Perhaps an "essential" gene should be essential in all conditions?
    % The reference list of "essential" genes is included at the end of
    % this function.

    if output
        fprintf('\nMaking complex medium...\n');
    end
    ...
    case {'iff708_valid_modified.xml'}
        ...
        model.ub(uptake_rxn_indexes) = 1000;
    ...
    %% use model-provided biomass def
    %
    if biomass == 0
        if output
            fprintf('\nUsing model-default biomass def...\n');
        end
    end

    %% use iFF biomass def
    % all models but iIN can grow with the iFF biomass definition, so use it.
    %
        ...
        switch lower(model.description)
            ...
            case {'yeast_7.00_cobra'}
                model=changeRxnMets(model,...
                    ...
                    %'s_1331';... % phosphatidate [cytoplasm], met s_1331
                    %is not in 6.91
                    's_1346';'s_1351';'s_1337';'s_1467';'s_1524';'s_1545';...
                    's_1569';'s_0394';'s_0450';'s_1322';}, ... %new mets
                    {'r_2133';}, ... %rxn id
                    ...
                    -0.0066;-0.3018;-0.1054;-0.0663;-0.1927;-0.2964;...
                    -0.2862;-0.0507;-0.1339;-0.1647;-0.1854;-0.1914;...
                    -0.0284;-0.102;-0.2646;-0.8079;...
                    %-0.0006; % phosphatidate [cytoplasm], met s_1331
                    %is not in 6.91
                    -0.006;...
                    -0.0045;-0.0017;-0.02;-0.0066;-0.0599;-0.0015;...
                    59.276;1;59.305;]); %stoichiometric coefficients
    ...
    switch lower(model.description)
        case {'iff708_valid_modified.xml'} 
            uptake_rxn_ids = {'ZYMSTxtI';'XANxtI';'URIxtI';'UREAxtI';'URAxtI';'THYxtI';'DTxtI';'THMxtI';'SLFxtI';'SUCxtI';'SUCCxtI';'C180xtI';'SPRMxtI';'SORxtI';'NAxtI';'MMETxtI';'SAMxtI';'RFLAVxtI';'PYRxtI';'KxtI';'PIMExtI';'PIxtI';'PEPTxtI';'C160xtI';'O2xtI';'OGTxtI';'OPEPxtI';'NMNxtI';'NH3xtI';'C140xtI';'MIxtI';'MTHNxtI';'MELIxtI';'MLTxtI';'MALxtI';'VALxtI';'TYRxtI';'TRPxtI';'THRxtI';'SERxtI';'PROxtI';'PHExtI';'ORNxtI';'METxtI';'LYSxtI';'LEUxtI';'ILExtI';'HISxtI';'GLNxtI';'GLUxtI';'GLTxtI';'CYSxtI';'ASPxtI';'ASNxtI';'ARGxtI';'ALAxtI';'INSxtI';'HYXNxtI';'GSNxtI';'GNxtI';'GLALxtI';'GLYxtI';'GLxtI';'GLAMxtI';'GABAxtI';'FUMxtI';'FORxtI';'ETHxtI';'ERGOxtI';'DTTPxtI';'RIBxtI';'RMNxtI';'MNTxtI';'DIPEPxtI';'GA6PxtI';'GLACxtI';'FRUxtI';'DUxtI';'DINxtI';'DGxtI';'DCxtI';'DAxtI';'ARABxtI';'CYTSxtI';'CYTDxtI';'CO2xtI';'CITxtI';'CHOxtI';'BTxtI';'BMxtI';'FUCxtI';'MANxtI';'GLCxtI';'TRExtI';'ATNxtI';'PAPxtI';'ADNxtI';'ADxtI';'ACxtI';'ACALxtI';'AONAxtI';'DANNAxtI';'AKGxtI';'PNTOxtI';'LACxtI';};
            uptake_rxn_indexes = findRxnIDs(model, uptake_rxn_ids);
    ...
    %% knockout analysis
    % compare gene essentiality predictions in complex media against a list
    % of "essential" genes. The problem with this is that the "essential"
    % genes are defined from the stanford yeast knock-out collection, which
    % was screened in complex media supplemented with amino acids required
    % by genetic markers, so it's not an ideal reference gene list.
    % However, we can compare all models against it, so it's useful for
    % comparative purposes. The reference lists of genes are at the end of
    % this function.
...
function genes = inviableORFs
    % list of 1192 unique essential ORFs taken from the Yeast Deletion
    % Project (14 aug 11)
